...
typedef enum {
        ...
        HW_GPIO_FUNC_ISO_CLK = 7,               /**< GPIO as ISO CLK */
        HW_GPIO_FUNC_ISO_DATA = 8,              /**< GPIO as ISO DATA */
        HW_GPIO_FUNC_SPI_DI = 9,                /**< GPIO as SPI DI */
        HW_GPIO_FUNC_SPI_DO = 10,               /**< GPIO as SPI DO */
        HW_GPIO_FUNC_SPI_CLK = 11,              /**< GPIO as SPI CLK */
        HW_GPIO_FUNC_SPI_EN = 12,               /**< GPIO as SPI EN */
        HW_GPIO_FUNC_SPI_EN2 = 13,              /**< GPIO as SPI EN */
        HW_GPIO_FUNC_I2C_SCL = 14,              /**< GPIO as I2C2 SCL */
        HW_GPIO_FUNC_I2C_SDA = 15,              /**< GPIO as I2C2 SDA */
        HW_GPIO_FUNC_ADC = 16,                  /**< GPIO as ADC (dedicated pin) */
        HW_GPIO_FUNC_PCM_DI = 17,               /**< GPIO as PCM DI */
        HW_GPIO_FUNC_PCM_DO = 18,               /**< GPIO as PCM DO */
        HW_GPIO_FUNC_PCM_FSC = 19,              /**< GPIO as PCM FSC */
        HW_GPIO_FUNC_PCM_CLK = 20,              /**< GPIO as PCM CLK */
        HW_GPIO_FUNC_PDM_DATA = 21,             /**< GPIO as PDM DATA */
        HW_GPIO_FUNC_PDM_CLK = 22,              /**< GPIO as PDM CLK */
        HW_GPIO_FUNC_CLOCK = 23,                /**< GPIO as CLOCK */
        HW_GPIO_FUNC_TIM_PWM = 24,              /**< GPIO as TIM PWM */
        HW_GPIO_FUNC_TIM2_PWM = 25,             /**< GPIO as TIM2 PWM */
        HW_GPIO_FUNC_TIM_1SHOT = 26,            /**< GPIO as TIM 1SHOT */
        HW_GPIO_FUNC_TIM2_1SHOT = 27,           /**< GPIO as TIM2 1SHOT */
        HW_GPIO_FUNC_TIM3_PWM = 28,             /**< GPIO as TIM3 PWM */
        HW_GPIO_FUNC_TIM4_PWM = 29,             /**< GPIO as TIM4 PWM */
        HW_GPIO_FUNC_COEX_EXT_ACT = 30,         /**< GPIO as COEX EXT ACT0 */
        HW_GPIO_FUNC_COEX_SMART_ACT = 31,       /**< GPIO as COEX SMART ACT */
        HW_GPIO_FUNC_COEX_SMART_PRI = 32,       /**< GPIO as COEX SMART PRI */
        HW_GPIO_FUNC_PORT0_DCF = 33,            /**< GPIO as PORT0 DCF */
        HW_GPIO_FUNC_PORT1_DCF = 34,            /**< GPIO as PORT1 DCF */
        HW_GPIO_FUNC_PORT2_DCF = 35,            /**< GPIO as PORT2 DCF */
        HW_GPIO_FUNC_PORT3_DCF = 36,            /**< GPIO as PORT3 DCF */
        HW_GPIO_FUNC_PORT4_DCF = 37,            /**< GPIO as PORT4 DCF */
        HW_GPIO_FUNC_CMAC_DIAG0 = 38,           /**< GPIO as CMAC DIAG0 */
        HW_GPIO_FUNC_CMAC_DIAG1 = 39,           /**< GPIO as CMAC DIAG1 */
        HW_GPIO_FUNC_CMAC_DIAG2 = 40,           /**< GPIO as CMAC DIAG2 */
        HW_GPIO_FUNC_CMAC_DIAG3 = 41,           /**< GPIO as CMAC DIAG3 */
        HW_GPIO_FUNC_CMAC_DIAG4 = 42,           /**< GPIO as CMAC DIAG4 */
        HW_GPIO_FUNC_CMAC_DIAG5 = 43,           /**< GPIO as CMAC DIAG5 */
        HW_GPIO_FUNC_CMAC_DIAG6 = 44,           /**< GPIO as CMAC DIAG6 */
        HW_GPIO_FUNC_CMAC_DIAG7 = 45,           /**< GPIO as CMAC DIAG7 */
        HW_GPIO_FUNC_CMAC_DIAG8 = 46,           /**< GPIO as CMAC DIAG8 */
        HW_GPIO_FUNC_CMAC_DIAG9 = 47,           /**< GPIO as CMAC DIAG9 */
        HW_GPIO_FUNC_CMAC_DIAG10 = 48,          /**< GPIO as CMAC DIAG10 */
        HW_GPIO_FUNC_CMAC_DIAG11 = 49,          /**< GPIO as CMAC DIAG11 */
        HW_GPIO_FUNC_CMAC_DIAG12 = 50,          /**< GPIO as CMAC DIAG12 */
        HW_GPIO_FUNC_CMAC_DIAG13 = 51,          /**< GPIO as CMAC DIAG13 */
        HW_GPIO_FUNC_CMAC_DIAG14 = 52,          /**< GPIO as CMAC DIAG14 */
        HW_GPIO_FUNC_CMAC_DIAG15 = 53,          /**< GPIO as CMAC DIAG15 */
        HW_GPIO_FUNC_LAST,
} HW_GPIO_FUNC;

/**
 * \brief Clocks that can be mapped to GPIOs
 *
 */
typedef enum {
        HW_GPIO_CLK_XTAL32K = 0,
        HW_GPIO_CLK_RCLP = 1,
        HW_GPIO_CLK_RCX = 2,
        HW_GPIO_CLK_XTAL32M = 3,
        HW_GPIO_CLK_RC32M = 4,
        HW_GPIO_CLK_DIVN = 5,
        HW_GPIO_CLK_LAST,
} HW_GPIO_CLK;
...
/**
 * \brief GPIOs Drive Strength
 *
 */
typedef enum {
        HW_GPIO_DRIVE_STRENGTH_NORMAL = 0, /**<  pin configured with normal (full) drive strength (default) */
        HW_GPIO_DRIVE_STRENGTH_WEAK,       /**<  pin configured with weak (reduced) drive strength */
 ...
 *
 * \note  The Drive Strength is pad (GPIO) related featured.
 *        The default setting is the Normal Drive Strength.
 *        The pads P0_0 .. P0_5 do not support the weak drive strength function.
 *        Using the function of weak drive on P0_0 .. P0_5 pads has no effect
 *
 *
 * \param [in] port GPIO port
 * \param [in] pin GPIO pin
 * \param [in] strength GPIO Drive Strength
 *
 */
void hw_gpio_set_pin_drive_strength(HW_GPIO_PORT port, HW_GPIO_PIN pin, HW_GPIO_DRIVE_STRENGTH strength);

/**
 * \brief Get the pin drive strength
 *
 * \param [in] port GPIO port
 * \param [in] pin GPIO pin
 * \return HW_GPIO_DRIVE_STRENGTH the GPIO Drive Strength
 *
 */
...
/**
 * \brief Enable mapping of selected clock to the respective GPIO
 *
 * DIVN is mapped to GPIO P0_8
 * XTAL32M is mapped to GPIO P0_11
 * RC32M is mapped to GPIO P1_02
 *
...
{
        switch (clk) {
        case HW_GPIO_CLK_XTAL32M:
                REG_SET_BIT(GPIO, GPIO_CLK_SEL_REG, XTAL32M_OUTPUT_EN);
                break;
        case HW_GPIO_CLK_RC32M:
                REG_SET_BIT(GPIO, GPIO_CLK_SEL_REG, RC32M_OUTPUT_EN);
                break;
        case HW_GPIO_CLK_DIVN:
                REG_SET_BIT(GPIO, GPIO_CLK_SEL_REG, DIVN_OUTPUT_EN);
                break;
        default:
                ASSERT_WARNING(0);
                break;
...
__STATIC_INLINE void hw_gpio_clk_output_disable(HW_GPIO_CLK clk)
{
        switch (clk) {
        case HW_GPIO_CLK_XTAL32M:
                REG_CLR_BIT(GPIO, GPIO_CLK_SEL_REG, XTAL32M_OUTPUT_EN);
                break;
        case HW_GPIO_CLK_RC32M:
                REG_CLR_BIT(GPIO, GPIO_CLK_SEL_REG, RC32M_OUTPUT_EN);
                break;
        case HW_GPIO_CLK_DIVN:
                REG_CLR_BIT(GPIO, GPIO_CLK_SEL_REG, DIVN_OUTPUT_EN);
                break;
        default:
                ASSERT_WARNING(0);
                break;
...
{
        REG_SETF(GPIO, GPIO_CLK_SEL_REG, FUNC_CLOCK_SEL, clk_src);
}
...
{
        uint8_t  pin_select = REG_MSK(CRG_TOP, POR_PIN_REG, POR_PIN_SELECT);
        if (port == HW_GPIO_PORT_0) {
