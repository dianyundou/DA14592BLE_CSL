 ...
 * \{
 * \addtogroup BLE_SER_HID HID Service
 *
 * \brief HID service sample implementation API
 * \{
 */
 ...
 * \param [in] length           length of data
 * \param [in] data             new value
 * \param [out] ble_err         BLE operation error code
 *
 ...
 */
bool hids_notify_input_report(ble_service_t *svc, uint8_t report_id,
                              uint16_t length, const uint8_t *data, ble_error_t *ble_err);
