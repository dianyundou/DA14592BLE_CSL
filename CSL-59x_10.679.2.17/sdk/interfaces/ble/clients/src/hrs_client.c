...
static void serialize(ble_client_t *client, void *data, size_t *length)
{
        ...
        *length = sizeof(hrs_client_serialized_t);
        ...
        s_data->start_h                 = hrs_client->client.start_h;
        s_data->end_h                   = hrs_client->client.end_h;
                                                        ...
                                                        const ble_evt_gattc_browse_svc_t *evt)
{
        ...
        hrs_client->client.start_h = evt->start_h;
        hrs_client->client.end_h = evt->end_h;

        /* Discover Heart Rate Service's characteristics and descriptors */
                                                                ...
                                                                const void *data, size_t length)
{
        ...
        hrs_client->client.start_h              = s_data->start_h;
        hrs_client->client.end_h                = s_data->end_h;
