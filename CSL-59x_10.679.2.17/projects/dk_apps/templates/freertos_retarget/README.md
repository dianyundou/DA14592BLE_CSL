...
- `DA1459X-00-Debug_eFLASH`.    The project is built to be run from eFLASH. The executable is built with debug (-Og) information.
...
- `DA1459X-00-Release_eFLASH`.  The project is built to be run from eFLASH. The executable is built with no debug information and size optimization (-Os).
