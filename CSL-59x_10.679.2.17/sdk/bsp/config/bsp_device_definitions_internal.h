...
/* DA1459X Device Variants */
#define DA14592                         (_DEVICE_MK_FAMILY(590) | _DEVICE_MK_VARIANT(2))
/* FPGA Device */
#define D2634                           (_DEVICE_MK_FAMILY(590) | DEVICE_CHIP_ID_2634 | \
                                         _DEVICE_FPGA_MASK | DEVICE_REV_A)
/* Family Wildcard */
#define DA1459X                         (_DEVICE_MK_FAMILY(590))
...
#define DEVICE_CHIP_ID_2634             (_DEVICE_MK_CHIP_ID(2634))
...
#define DEVICE_VER_AC                   (_DEVICE_MK_VER(A, DONT_CARE, C))
...
#define DA14592_2634_00                 (DA14592 | _DEVICE_MK_CHIP_ID(2634) | DEVICE_VER_A1)
