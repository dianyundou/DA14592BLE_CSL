...
/* Handle of motion detector instance for Google Fast Pair framework */
__FP_RETAINED static motion_detector_handle_t fp_motion_detector_hdl;
...
void fp_motion_detector_init(const fp_motion_detector_config_t *cfg)
{
        ...
        fp_motion_detector_hdl = motion_detector_init(&motion_det_cfg);
        OS_ASSERT(fp_motion_detector_hdl);
}

void fp_motion_detector_deinit(void)
{
        motion_detector_deinit(fp_motion_detector_hdl);
}

void fp_motion_detector_enable(void)
{
        motion_detector_enable(fp_motion_detector_hdl);
}

void fp_motion_detector_disable(void)
{
        motion_detector_disable(fp_motion_detector_hdl);
}
#endif /* FP_FMDN */
