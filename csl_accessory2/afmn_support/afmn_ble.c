 ...
 * @file afmn_ble.c
 *
 * @brief Apple FMN BLE operations implementation
 *
...
/* Advertising event used for Apple FMN */
__RETAINED static adv_control_event_t afmn_adv_evt;

void afmn_ble_adv_init(void)
{
        afmn_adv_evt = adv_control_event_create(NULL);
        OS_ASSERT(afmn_adv_evt);
}

void afmn_ble_adv_deinit(void)
{
        ble_error_t ret = adv_control_event_delete(afmn_adv_evt);
...
ble_error_t afmn_ble_adv_set_params(const afmn_ble_adv_params_t *params)
{
        ...
        return adv_control_event_set_params(afmn_adv_evt, &adv_params);
}
...
{
        return adv_control_event_set_ad_struct(afmn_adv_evt, ad_len, ad, sd_len, sd);
}

ble_error_t afmn_ble_adv_start(void)
{
        return adv_control_event_start(afmn_adv_evt);
}

bool afmn_ble_adv_is_started(void)
{
        return adv_control_event_is_active(afmn_adv_evt);
}

ble_error_t afmn_ble_adv_stop(void)
{
        return adv_control_event_stop(afmn_adv_evt);
}
