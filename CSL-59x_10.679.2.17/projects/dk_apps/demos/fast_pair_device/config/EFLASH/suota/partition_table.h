...
#else
#define NVMS_FW_EXEC_PART_START         (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x02000)
#define NVMS_FW_EXEC_PART_SIZE          (0x01D800)
#define NVMS_PARAM_PART_START           (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x1F800)
#define NVMS_PARAM_PART_SIZE            (0x000800)
#define NVMS_FW_UPDATE_PART_START       (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x20000)
#define NVMS_FW_UPDATE_PART_SIZE        (0x01D800)
#define NVMS_GENERIC_PART_START         (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x3D800)
#define NVMS_GENERIC_PART_SIZE          (0x002000)
