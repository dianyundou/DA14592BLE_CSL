...
static uint16_t app_params_access_params(APP_PARAMS_ACCESS access, app_params_t *params, uint8_t n)
{
        ...
        nvparam_t nvparam;
#if (dg_configSUOTA_ASYMMETRIC == 1)
        /* Parameter length shall be long enough to store address type and renewal duration,
         * max advertise data length and validity flag */
        ...
        static const struct {
                ...
                [FP_CONN_PARAMS_BLE_PERSONALIZED_NAME]          = { APP_PARAMS_NV_AREA_FP_APP,
                                                                    TAG_FP_APP_PERSONALIZED_NAME },
#endif
#if (FP_FMDN == 1)
                [FP_CONN_PARAMS_BLE_EPHEMERAL_IDENTITY_KEY]     = { APP_PARAMS_NV_AREA_FP_APP,
                                                                    TAG_FP_APP_EPHEMERAL_IDENTITY_KEY },
#endif
                [FP_CONN_PARAMS_BLE_ACCOUNT_KEY_LIST]           = { APP_PARAMS_NV_AREA_FP_APP,
                                                                    TAG_FP_APP_ACCOUNT_KEY_LIST },
                [APP_PARAMS_BLE_APP_NAME]                       = { APP_PARAMS_NV_AREA_BLE_APP,
                                                                    TAG_BLE_APP_NAME },
#if (FP_FMDN == 1)
                [APP_PARAMS_BEACON_TIME]                        = { APP_PARAMS_NV_AREA_FP_APP,
                                                                    TAG_FP_APP_BEACON_TIME },
#endif
#if (dg_configSUOTA_ASYMMETRIC == 1)
                [APP_PARAMS_ASYM_SUOTA_ADV_DATA]                = { APP_PARAMS_NV_AREA_ASYM_SUOTA_CONFIG_DYN,
                                                                    TAG_ASYM_SUOTA_ADV_DATA },
                [APP_PARAMS_ASYM_SUOTA_ADV_DATA_LEN]            = { APP_PARAMS_NV_AREA_ASYM_SUOTA_CONFIG_DYN,
                                                                    TAG_ASYM_SUOTA_ADV_DATA_LEN },
                [APP_PARAMS_ASYM_SUOTA_BD_ADDR_TYPE]            = { APP_PARAMS_NV_AREA_ASYM_SUOTA_CONFIG_DYN,
                                                                    TAG_ASYM_SUOTA_BD_ADDR_TYPE },
                [APP_PARAMS_ASYM_SUOTA_BD_ADDR_RENEW_DUR]       = { APP_PARAMS_NV_AREA_ASYM_SUOTA_CONFIG_DYN,
                                                                    TAG_ASYM_SUOTA_BD_ADDR_RENEW_DUR }
        ...
        for (uint8_t i = 0; i < n; i++) {
                ...
                if (param_len == 0) {
                        ...
                        if (access_len != param_len) {
                                FP_TASK_PRINTF("ERROR: Problem in writing parameter %d (%u bytes) to NVM\r\n",
