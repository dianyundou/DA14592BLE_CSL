...
#define NVMS_FIRMWARE_PART_START        (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x00003000)
#define NVMS_FIRMWARE_PART_SIZE         (0x0006D000)
#define NVMS_PARAM_PART_START           (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x00070000)
#define NVMS_PARAM_PART_SIZE            (0x00010000)
#define NVMS_BIN_PART_START             (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x00080000)
#define NVMS_BIN_PART_SIZE              (0x00060000)
#define NVMS_LOG_PART_START             (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x000E0000)
#define NVMS_LOG_PART_SIZE              (0x00010000)
#define NVMS_GENERIC_PART_START         (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x000F0000)
