...
/* --------------------------   PRIORITY SETUP       --------------------------------------*/
/******************************************************************************************/
#define RWBLE_PRIORITY_ADV_LDC_DEFAULT    (0)
#define RWBLE_PRIORITY_SCAN_DEFAULT       (0)
#define RWBLE_PRIORITY_MCONNECT_DEFAULT   (3)
#define RWBLE_PRIORITY_SCONNECT_DEFAULT   (3)
#define RWBLE_PRIORITY_ADV_HDC_DEFAULT    (5)
#define RWBLE_PRIORITY_INIT_DEFAULT       (5)
#define RWBLE_PRIORITY_MAX_DEFAULT        (6)

#define RWBLE_PRIORITY_ADV_LDC    get_cfg_setting(rwble_priority_adv_ldc_pos)
#define RWBLE_PRIORITY_SCAN       get_cfg_setting(rwble_priority_scan_pos)
#define RWBLE_PRIORITY_MCONNECT   get_cfg_setting(rwble_priority_mconnect_pos)
#define RWBLE_PRIORITY_SCONNECT   get_cfg_setting(rwble_priority_sconnect_pos)
#define RWBLE_PRIORITY_ADV_HDC    get_cfg_setting(rwble_priority_adv_hdc_pos)
#define RWBLE_PRIORITY_INIT       get_cfg_setting(rwble_priority_init_pos)
#define RWBLE_PRIORITY_MAX        get_cfg_setting(rwble_priority_max_pos)
...
#define RWBLE_PROG_LATENCY_DFT         get_cfg_setting(rwble_prog_latency_dft_pos)
/// EA asap latency
#define RWBLE_ASAP_LATENCY             get_cfg_setting(rwble_asap_latency_pos)
...
//byte10
#define BLE_CMDS_BYTE10     BLE_RD_TX_PWR_CMD
//byte14
...
#ifdef F_2M //5.0 2M
#undef BLE_CMDS_BYTE35
#define BLE_CMDS_BYTE35     (BLE_READ_LOCAL_RPA_CMD | BLE_SET_ADDR_RESOLUTION_ENABLE_CMD | BLE_SET_RPA_TO_CMD | BLE_RD_MAX_DATA_LENGTH_CMD | \
                                BLE_READ_PHY_CMD | BLE_SET_DEFAULT_PHY_CMD | BLE_SET_PHY_CMD | BLE_LE_RX_TEST_ENH_CMD)

#undef BLE_CMDS_BYTE36
#define BLE_CMDS_BYTE36     (BLE_LE_TX_TEST_ENH_CMD)
#endif // F_2M
//byte38
#define BLE_CMDS_BYTE38     (BLE_LE_READ_TRANSMIT_POWER)
//byte39 (ESR10)
#ifdef F_PCLE
#define BLE_CMDS_BYTE39     (BLE_LE_RD_RF_PATH_COMPENSATION_CMD | BLE_LE_WR_RF_PATH_COMPENSATION_CMD | BLE_LE_SET_PRIVACY_MODE_CMD | \
...
//byte44
#ifdef F_PCLE
#define BLE_CMDS_BYTE44     (BLE_LE_RD_TX_PWR_LVL_ENH_CMD | BLE_LE_RD_REM_TX_PWR_LVL_CMD | \
                             BLE_LE_SET_PATH_LOSS_REPORT_PARAMS_CMD | BLE_LE_SET_PATH_LOSS_REPORT_EN_CMD | \
                             BLE_LE_SET_TX_PWR_REPORT_EN_CMD)
#else
#define BLE_CMDS_BYTE44     (0)
#endif // F_PCLE
...
#else
#define BLE_CMDS_BYTE45     (0)
#endif // F_PCLE

#endif // (RWBLE_SW_VERSION_MAJOR >= 9)
//byte41
#define BLE_CMDS_BYTE41     (BLE_LE_GENERATE_DHKEY_V2_CMD)
