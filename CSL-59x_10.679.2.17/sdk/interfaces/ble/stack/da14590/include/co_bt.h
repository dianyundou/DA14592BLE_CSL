...
#ifdef F_2M
//5.0 2M
#define LL_PHY_REQ_LEN           0x03
#define LL_PHY_RSP_LEN           0x03
#define LL_PHY_UPDATE_IND_LEN    0x05
#endif
#endif /* (RWBLE_SW_VERSION_MAJOR >= 8) */
#if (RWBLE_SW_VERSION_MAJOR >= 9)
#ifdef F_PCLE
#define LL_PWR_CONTROL_REQ_LEN   0x04
#define LL_PWR_CONTROL_RSP_LEN   0x05
#define LL_PWR_CHANGE_IND_LEN    0x05
#endif // F_PCLE
...
//5.0 2M
//byte 1
#define BLE_LE_2M_PHY_FEATURE               0x01
#else
#define BLE_LE_2M_PHY_FEATURE               0x00
#endif

#ifdef F_CH2
//5.0 CH2
//byte 1
#define BLE_CH_SEL_FEATURE                  0x40
#else
#define BLE_CH_SEL_FEATURE                  0x00
#endif
#endif /* (RWBLE_SW_VERSION_MAJOR >= 8) */
//byte 4
#if (RWBLE_SW_VERSION_MAJOR >= 9)
#ifdef F_PCLE
#define BLE_PWR_CONTROL_REQ_FEATURE         0x02
#define BLE_PWR_CHANGE_IND_FEATURE          0x04
#define BLE_PATH_LOSS_MONITOR_FEATURE       0x08
#endif // F_PCLE
#endif /* (RWBLE_SW_VERSION_MAJOR >= 9) */
...
#ifdef F_2M
//5.0 2M
#define BLE_READ_PHY_CMD                                0x10
#define BLE_SET_DEFAULT_PHY_CMD                         0x20
#define BLE_SET_PHY_CMD                                 0x40
#define BLE_LE_RX_TEST_ENH_CMD                          0x80
#endif
...
#ifdef F_2M
//5.0 2M
#define BLE_LE_TX_TEST_ENH_CMD                          0x01
#endif

//byte38
#define BLE_LE_READ_TRANSMIT_POWER                      0x80

//byte39
#ifdef F_PCLE
#define BLE_LE_RD_RF_PATH_COMPENSATION_CMD              0x01
#define BLE_LE_WR_RF_PATH_COMPENSATION_CMD              0x02
...
//byte41
#define BLE_LE_GENERATE_DHKEY_V2_CMD                    0x04

#if (RWBLE_SW_VERSION_MAJOR >= 9)
#ifdef F_PCLE
//byte44
#define BLE_LE_RD_TX_PWR_LVL_ENH_CMD                    0x08
#define BLE_LE_RD_REM_TX_PWR_LVL_CMD                    0x10
#define BLE_LE_SET_PATH_LOSS_REPORT_PARAMS_CMD          0x20
#define BLE_LE_SET_PATH_LOSS_REPORT_EN_CMD              0x40
#define BLE_LE_SET_TX_PWR_REPORT_EN_CMD                 0x80
...
#ifdef F_2M
//GZ 5.0 2M
#define    LE_PHY_UPDATE_CMP_EVT_BIT     11
#define    LE_PHY_UPDATE_CMP_EVT_MSK     0x800
#endif

#ifdef F_CH2
//GZ 5.0 CH2
#define    LE_CH_SEL_EVT_BIT             19
#define    LE_CH_SEL_EVT_MSK             0x80000
#endif
#if (RWBLE_SW_VERSION_MAJOR >= 9)
#ifdef F_PCLE
#define    LE_PATH_LOSS_THRES_EVT_BIT    31
#define    LE_PATH_LOSS_THRES_EVT_MSK    0x80000000
#define    LE_TX_PWR_REPORT_EVT_BIT      32
#define    LE_TX_PWR_REPORT_EVT_MSK      0x100000000
#endif // F_PCLE
#endif /*RWBLE_SW_VERSION_MAJOR >= 9*/
#endif /* (RWBLE_SW_VERSION_MAJOR >= 8) */
...
//5.0 2M
    ...
    LL_POWER_CONTROL_REQ = 0x23, // previous opcodes missing, so assigning to correct
