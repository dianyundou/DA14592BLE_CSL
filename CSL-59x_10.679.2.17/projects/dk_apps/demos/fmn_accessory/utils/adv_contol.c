...
#define ADV_CONTROL_EVENT_COUNT_MAX             (1)
#endif
...
static void adv_control_send_notifiation(void)
{
...
ble_error_t adv_control_event_set_tx_power(adv_control_event_t evt, gap_tx_power_t tx_power)
{
        ...
        if (adv_evt->is_active && adv_control_last_evt == adv_evt) {
