...
startup/DA1459x/GCC/deepsleep.o: C:/RenesasWork/BLETag/ble_tag_workspace2/CSL-59x_10.679.2.17/sdk/bsp/startup/DA1459x/GCC/deepsleep.S
	$(file > $@.in,-mcpu=cortex-m33 -mthumb -mfloat-abi=hard -mfpu=fpv5-sp-d16 -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -Werror -Wall -g3 -x assembler-with-cpp -Ddg_configDEVICE=DA14592_00 -DRELEASE_BUILD -I"C:/RenesasWork/BLETag/ble_tag_workspace2/csl_accessory2/config" -I"C:/RenesasWork/BLETag/ble_tag_workspace2/CSL-59x_10.679.2.17/sdk/bsp/config" -I"C:/RenesasWork/BLETag/ble_tag_workspace2/CSL-59x_10.679.2.17/sdk/middleware/config" -include"C:/RenesasWork/BLETag/ble_tag_workspace2/csl_accessory2/config/custom_config_eflash.h" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<")
