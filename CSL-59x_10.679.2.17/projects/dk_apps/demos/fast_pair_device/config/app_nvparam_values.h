 ...
 */
#if (FP_FMDN == 1)
#define BLE_APP_NAME    'R', 'e', 'n', 'e', 's', 'a', 's', ' ', 'F', 'M', 'D', 'N', ' ', \
                        'A', 'c', 'c', 'e', 's', 's', 'o', 'r', 'y'
#else
#define BLE_APP_NAME    'R', 'e', 'n', 'e', 's', 'a', 's', ' ', 'F', 'a', 's', 't', ' ', \
                        'P', 'a', 'i', 'r', ' ', 'D', 'e', 'v', 'i', 'c', 'e'
#endif /* FP_FMDN */
...
#if (FP_FMDN == 1)
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_SCAN_RESP_DATA,     uint8_t, 0x17, 0x09, BLE_APP_NAME,
                                                                0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,       0x00)
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_SCAN_RESP_DATA_LEN, uint8_t, 0x18,                                           0x00) // 24 bytes
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_DEVICE_NAME,        uint8_t, BLE_APP_NAME, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                                0xFF, 0xFF, 0xFF, 0xFF,                         0x00)
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_DEVICE_NAME_LEN,    uint8_t, 0x16,                                           0x00) // 22 bytes
#else
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_SCAN_RESP_DATA,     uint8_t, 0x19, 0x09, BLE_APP_NAME,
                                                                0xFF, 0xFF, 0xFF, 0xFF, 0xFF,                   0x00)
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_SCAN_RESP_DATA_LEN, uint8_t, 0x1A,                                           0x00) // 26 bytes
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_DEVICE_NAME,        uint8_t, BLE_APP_NAME, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                                0xFF, 0xFF,                                     0x00)
NVPARAM_PARAM_VALUE(TAG_ASYM_SUOTA_DEVICE_NAME_LEN,    uint8_t, 0x18,                                           0x00) // 24 bytes
#endif /* FP_FMDN */
