...
static void serialize(ble_client_t *client, void *data, size_t *length)
{
        ...
        *length = sizeof(dis_client_serialized_t);
        ...
        s_data->start_h              = dis_client->client.start_h;
        s_data->end_h                = dis_client->client.end_h;
}
                                                        ...
                                                        const ble_evt_gattc_browse_svc_t *evt)
{
        ...
        dis_client->client.start_h = evt->start_h;
        dis_client->client.end_h = evt->end_h;
                                                                    ...
                                                                    const void *data, size_t length)
{
        ...
        dis_client->client.start_h       = d->start_h;
        dis_client->client.end_h         = d->end_h;
