...
#define NVMS_FIRMWARE_PART_SIZE         (0x003B000)
#define NVMS_GENERIC_PART_START         (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x3D000)
#define NVMS_GENERIC_PART_SIZE          (0x0001000)
#define NVMS_PARAM_PART_START           (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x3E000)
#define NVMS_PARAM_PART_SIZE            (0x0001000)
#define NVMS_LOG_PART_START             (EFLASH_MEM1_VIRTUAL_BASE_ADDR + 0x3F000)
#define NVMS_LOG_PART_SIZE              (0x0000800)
