...
SYMMETRIC_KEYS_NUM = {ProductId.DA1459x_00: 8, ProductId.DA14683_00: 8, ProductId.DA1469x_00: 8}
SYMMETRIC_KEYS_LEN = {ProductId.DA1459x_00: 32, ProductId.DA14683_00: 32, ProductId.DA1469x_00: 32}
ASYMMETRIC_KEYS_NUM = {ProductId.DA1459x_00: 8, ProductId.DA14683_00: 4, ProductId.DA1469x_00: 8}
SYMMETRIC_FW_DEC_KEYS_NUM = {ProductId.DA1459x_00: 0, ProductId.DA14683_00: 0, ProductId.DA1469x_00: 8}
SYMMETRIC_FW_DEC_KEYS_LEN = {ProductId.DA1459x_00: 0, ProductId.DA14683_00: 0, ProductId.DA1469x_00: 32}

ALLOWED_ELLIPTIC_CURVES = [
    EllipticCurve.EDWARDS25519
]

DEFAULT_ELLIPTIC_CURVE_IDX = ALLOWED_ELLIPTIC_CURVES.index(EllipticCurve.EDWARDS25519)
...
class ProductKeys:
    ...
    def is_valid(self, prod_id):
        if prod_id != ProductId.DA1469x_00 and prod_id != ProductId.DA14683_00 and prod_id != ProductId.DA1459x_00:
            return False
...
def parse_args():
    ...
    parser.add_argument('-ec', '--elliptic_curve', dest='elliptic_curve',
                        help='elliptic curve (omitted for DA1459x devices)',
