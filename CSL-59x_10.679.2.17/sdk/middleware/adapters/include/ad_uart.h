 ...
 */
typedef enum {
        AD_UART_ERROR_CONFIG_TX_SIZE            = -9,   /** Invalid TX size */
        AD_UART_ERROR_CONFIG_RX_SIZE            = -8,   /** Invalid RX size */
        ...
        AD_UART_ERROR_AUTOFLOW_CONF_INVALID     = -2,   /** The auto flow control configuration is invalid. */
 ...
 */
typedef struct {
        uart_config  hw_conf;        /** Low lever driver configuration */
