...
/// Scan filter size
#define GAPM_SCAN_FILTER_SIZE   get_cfg_setting(gapm_scan_filter_size_pos)
...
typedef enum gapm_op_type gapm_op_type_t;
...
struct gapm_env_tag
{
    ...
    struct bd_addr rand_static_addr;
    // Mirror of the random address set to the controller
 ...
 *  - ATT_ERR_NO_ERROR: If database creation succeeds.
 *  - ATT_ERR_INVALID_HANDLE: If start_hdl given in parameter + nb of attribute override
 *                      some existing services handles.
 *  - ATT_ERR_INSUFF_RESOURCE: There is not enough memory to allocate service buffer.
 ...
 *****************************************************************************************
 */
void gapm_send_complete_evt(gapm_op_type_t op_type, uint8_t status);
 ...
 ****************************************************************************************
 */
__INLINE void* gapm_get_operation_ptr(gapm_op_type_t op_type)
{
 ...
 ****************************************************************************************
 */
__INLINE void gapm_set_operation_ptr(gapm_op_type_t op_type, void* op)
{
    ASSERT_ERR(op_type < GAPM_OP_MAX);
 ...
 ****************************************************************************************
 */
__INLINE bool gapm_svc_chg_en(void)
{
 ...
 ****************************************************************************************
 */
__INLINE bool gapm_dbg_mode_en(void)
{
 ...
 ****************************************************************************************
 */
uint8_t gapm_get_operation(gapm_op_type_t op_type);
 ...
 ****************************************************************************************
 */
bool gapm_reschedule_operation(gapm_op_type_t op_type);
 ...
 ****************************************************************************************
 */
ke_task_id_t gapm_get_requester(gapm_op_type_t op_type);
 ...
 *
 * @param[in] op_type  Air operation type
 * @param[in] con_params Connection parameters from lower layers
 *
 * @return Connection index allocated to the new connection.
 ****************************************************************************************
 */
uint8_t gapm_con_create(gapm_op_type_t op_type, struct hci_le_con_cmp_evt const *con_params);
