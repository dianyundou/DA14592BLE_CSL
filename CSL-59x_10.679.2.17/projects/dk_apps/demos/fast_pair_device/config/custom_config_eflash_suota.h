...
#define AD_NVMS_MAX_SECTOR_COUNT                ( 4 )
...
#undef AD_NVMS_MAX_SECTOR_COUNT
#define AD_NVMS_MAX_SECTOR_COUNT                ( 5 )  /* NVM area (with VES) increased, storing
                                                          also Asymmetric SUOTA configuration */
#else
#define defaultBLE_ATT_DB_CONFIGURATION         ( 0x10 )  /* Peripheral Pref. Conn. Param. present */
...
#if (dg_configSUOTA_ASYMMETRIC == 1)
#define configTOTAL_HEAP_SIZE                   ( 15 * 1024 )  /* FreeRTOS Total Heap Size */
#else
#define configTOTAL_HEAP_SIZE                   ( 17 * 1024 )  /* FreeRTOS Total Heap Size */
#endif
