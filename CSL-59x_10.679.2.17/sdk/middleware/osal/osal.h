...
/**
 * \brief Resume OS tasks scheduler
 */
#define OS_TASK_RESUME_ALL() _OS_TASK_RESUME_ALL()

/**
 * \brief Suspend OS tasks scheduler
 */
#define OS_TASK_SUSPEND_ALL() _OS_TASK_SUSPEND_ALL()
...
/* Enable scheduler to resume all tasks */
#ifndef _OS_TASK_RESUME_ALL
#error "OS_TASK_RESUME_ALL not defined"
#endif

/* Disable scheduler to suspend all tasks */
#ifndef _OS_TASK_SUSPEND_ALL
#error "OS_TASK_SUSPEND_ALL not defined"
#endif
