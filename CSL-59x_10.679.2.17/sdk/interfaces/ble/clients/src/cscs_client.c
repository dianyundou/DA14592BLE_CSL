...
static void serialize(ble_client_t *client, void *data, size_t *length)
{
        ...
        *length = sizeof(cscs_client_serialized_t);
        ...
        s_data->start_h                = cscs_client->client.start_h;
        s_data->end_h                  = cscs_client->client.end_h;
}
                                                        ...
                                                        const ble_evt_gattc_browse_svc_t *evt)
{
        ...
        cscs_client->client.start_h = evt->start_h;
        cscs_client->client.end_h = evt->end_h;
                                                                    ...
                                                                    const void *data, size_t length)
{
        ...
        cscs_client->client.start_h         = d->start_h;
        cscs_client->client.end_h           = d->end_h;
