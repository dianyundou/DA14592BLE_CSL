...
#define NVMS_FIRMWARE_PART_START        (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x003000)
...
#define NVMS_BIN_PART_START             (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x200000)
#define NVMS_BIN_PART_SIZE              (0x200000)
