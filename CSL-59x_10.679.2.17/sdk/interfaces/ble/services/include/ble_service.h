 ...
 * \{
 * \addtogroup BLE_SER_GENERAL Services Handling Routines
 *
 * \brief General BLE service routine handlers API
 * \{
 */
...
*
*/
__STATIC_INLINE uint8_t ble_service_get_num_attr(const ble_service_config_t *config, uint16_t chars,
                                                                                uint16_t descs)
{
