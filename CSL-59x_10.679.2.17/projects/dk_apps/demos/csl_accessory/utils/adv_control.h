...
/**
 * \brief Advertising control mode
 */
typedef enum {
        ADV_CONTROL_MODE_DISABLED,      /**< Advertising is disabled */
        ADV_CONTROL_MODE_NORMAL,        /**< Advertising is always enabled */
        ADV_CONTROL_MODE_LOW_POWER      /**< Advertising is periodically enabled/disabled */
} ADV_CONTROL_MODE;
...
/**
 * \brief Get advertising control mode
 *
 * \return advertising control mode
 */
ADV_CONTROL_MODE adv_control_get_mode(void);

/**
 * \brief Set advertising control mode
 *
 * \param [in] mode advertising control mode
 */
