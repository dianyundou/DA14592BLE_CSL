 ...
 *
 * \brief Access to specific hw_gpadc_config_t structure members and other essential configuration tweaks
 *
 * \{
 *
 */
 ...
 *        According to the \sa hw_gpadc_config_t passed in the above mentioned functions, the generic read function
 ...
 *
 * \note If in \sa hw_gpadc_config_t the \sa dma_setup section is valid, the converted results are transfered through DMA to the requested buffer.
