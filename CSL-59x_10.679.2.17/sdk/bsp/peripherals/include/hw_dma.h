...
#define HW_DMA_SECURE_DMA_CHANNEL               HW_DMA_CHANNEL_5
...
typedef enum {
        ...
        HW_DMA_DREQ_TRIGGERED = DMA_DMA0_CTRL_REG_DREQ_MODE_Msk         /**< DMA channel must be triggered by peripheral DMA request */
} HW_DMA_DREQ;
...
typedef enum {
        ...
        HW_DMA_BINC_TRUE  = DMA_DMA0_CTRL_REG_BINC_Msk  /**< Increment according value of BW */
} HW_DMA_BINC;
...
typedef enum {
        ...
        HW_DMA_AINC_TRUE  = DMA_DMA0_CTRL_REG_AINC_Msk  /**< Increment according value of BW */
} HW_DMA_AINC;
...
typedef enum {
        ...
        HW_DMA_MODE_CIRCULAR = DMA_DMA0_CTRL_REG_CIRCULAR_Msk   /**< Circular mode */
} HW_DMA_MODE;
...
typedef enum {
        ...
        HW_DMA_IDLE_INTERRUPTING_MODE = DMA_DMA0_CTRL_REG_DMA_IDLE_Msk  /**< Interrupting mode */
} HW_DMA_IDLE;
...
typedef enum {
        ...
        HW_DMA_INIT_AX_BX_BY    = DMA_DMA0_CTRL_REG_DMA_INIT_Msk        /**< DMA performs copy A1 to B1, B2 */
} HW_DMA_INIT;
...
typedef enum {
        ...
        HW_DMA_TRIG_UART_RXTX = 0x1,
        HW_DMA_TRIG_UART2_RXTX = 0x2,
        HW_DMA_TRIG_I2C_RXTX = 0x3,
        HW_DMA_TRIG_PCM_RXTX = 0x4,
        HW_DMA_TRIG_SRC_RXRX = 0x5,
        HW_DMA_TRIG_SRC_TXTX = 0x6,
        HW_DMA_TRIG_SRC2_RXRX = 0x7,
        HW_DMA_TRIG_SRC2_TXTX = 0x8,
        HW_DMA_TRIG_SRC_SRC2_RXTX = 0x9,
        HW_DMA_TRIG_SRC2_SRC_RXTX = 0xA,
        HW_DMA_TRIG_SRC_RXTX = 0xB,
        HW_DMA_TRIG_SRC2_RXTX = 0xC,
        HW_DMA_TRIG_ADC = 0xD,
        HW_DMA_TRIG_SD_ADC_FCU = 0xE,
...
{
        return (REG_GETF(CRG_TOP, SECURE_BOOT_REG, PROT_APP_KEY) == 1);
}
 ...
 *       of the Configuration Script (CS) in OTP is enabled(in eflash for DA1459X).
 */
__STATIC_INLINE bool hw_dma_secure_channel_is_free(void)
{
        uint32_t secure_features_msk = REG_MSK(CRG_TOP, SECURE_BOOT_REG, PROT_APP_KEY);

        return ((CRG_TOP->SECURE_BOOT_REG & secure_features_msk) == 0);
}
