...
/*
 * Note: Uninitialized section at system startup.
 */
#define SYS_TRNG_RETAINED_UNINIT        __RETAINED_UNINIT
...
SYS_TRNG_RETAINED_UNINIT static uint8_t sys_trng_seed[SYS_TRNG_SEED_SIZE] __ALIGNED(4);

SYS_TRNG_RETAINED_UNINIT static uint32_t trng_id;
...
#if (dg_configSYS_TRNG_ENTROPY_SRC_ADDR == MEMORY_CMAC_CACHERAM_BASE)
