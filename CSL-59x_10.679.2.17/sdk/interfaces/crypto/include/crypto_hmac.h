 ...
 */
typedef enum {
        CRYPTO_HMAC_NO_OPTION = 0x0,  /**< No option. */
        CRYPTO_HMAC_I_TXT = 0x1,      /**< The text passed is not complete. More chunks will follow. */
        CRYPTO_HMAC_F_TXT = 0x2       /**< The text passed is the final chunk. */
} CRYPTO_HMAC_OPTIONS;
