...
#define NVMS_GENERIC_PART_START         (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x080000)
#define NVMS_GENERIC_PART_SIZE          (0x020000)
#define NVMS_PLATFORM_PARAMS_PART_START (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x100000)
...
#define NVMS_LOG_PART_START             (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x200000)
#define NVMS_LOG_PART_SIZE              (0x100000)
#define NVMS_BIN_PART_START             (QSPI_MEM1_VIRTUAL_BASE_ADDR + 0x300000)
#define NVMS_BIN_PART_SIZE              (0x100000)
