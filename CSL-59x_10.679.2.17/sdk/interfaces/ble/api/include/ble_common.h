...
enum ble_evt_common {
        /** BLE has been reset */
        BLE_EVT_RESET_COMPLETED = BLE_EVT_CAT_FIRST(BLE_EVT_CAT_COMMON),
};
...
/** Radio Power Modes */
#define LOW_POWER_ALL_PHYS              ( 0x01 ) /**< Low Power (LP) mode */
#define HIGH_PERFORMANCE_ALL_PHYS       ( 0x02 ) /**< High Performance (HP) mode */
...
/** Structure for ::BLE_EVT_RESET_COMPLETED event */
typedef struct {
