 ...
 *
 * @brief QSPI flash driver for Winbond W25Q32JWIM_V2
 *
 ...
 ****************************************************************************************
 */
#ifndef _QSPI_W25Q32JWIM_V2_H_
#define _QSPI_W25Q32JWIM_V2_H_
...
#define QSPI_W25Q32JWIM_DENSITY                         (0x16)

__RETAINED_CODE static void qspi_w25q32jwim_initialize(HW_QSPIC_ID id, sys_clk_t sys_clk);

static const qspi_flash_config_t qspi_w25q32jwim_cfg = {
        .jedec.manufacturer_id                                  = QSPI_WINBOND_MANUFACTURER_ID,
        .jedec.type                                             = QSPI_WINBOND_W25QXXXJWIM_TYPE,
        .jedec.density                                          = QSPI_W25Q32JWIM_DENSITY,
        ...
        .callback.initialize_cb                                 = qspi_w25q32jwim_initialize,
