 ...
 *
 * Sets LED control mode. In case of LED_CONTROL_MODE_START_BLINK mode, the times LED blinks is
 * also set. LED_CONTROL_BLINK_FOREVER can be used to indicate constantly blinking LED.
 *
