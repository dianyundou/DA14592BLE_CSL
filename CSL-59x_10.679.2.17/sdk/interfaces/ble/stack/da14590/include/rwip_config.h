 ...
 *
 * Copyright (c) 2015-2025 Modified by Renesas Electronics Corporation and/or its affiliates.
 *
 *
 ****************************************************************************************
 */
...
/// Apple FMN Application
#if defined(CFG_APP_AFMN)
#define BLE_APP_AFMN         1
#else // defined(CFG_APP_AFMN)
#define BLE_APP_AFMN         0
#endif // defined(CFG_APP_AFMN)

/// Google FMDN Application
#if defined(CFG_APP_GFMDN)
#define BLE_APP_GFMDN        1
#else // defined(CFG_APP_GFMDN)
#define BLE_APP_GFMDN        0
#endif // defined(CFG_APP_GFMDN)
