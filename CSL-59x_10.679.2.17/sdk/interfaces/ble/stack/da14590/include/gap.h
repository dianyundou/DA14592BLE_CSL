 ...
 * "SMP") and transport module ("L2C"). It also includes the Generic
 ...
 * interfaces with both the "SMP", "L2C" and the "CONTROLLER"
 *
 * @{
 ****************************************************************************************
 */
...
#define GAP_LECB_CNX_MAX                get_cfg_setting(gap_lecb_cnx_max_pos)

/// maximum allowed value for private address refresh
#define GAP_TMR_PRIV_ADDR_INT_MAX       0x0E10  // (3600 s = 1 h)
