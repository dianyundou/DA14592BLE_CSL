 ...
 * @file main.c
 *
 * @brief Google Fast Pair device with Find My Device Network (FMDN) extension
 *
 ...
 * Task functions
 */
extern OS_TASK_FUNCTION(fast_pair_task, params);
...
static OS_TASK_FUNCTION(system_init, params)
{
        ...
        /* Start the application and Google Fast Pair framework OS task */
        status = OS_TASK_CREATE("fastpair",             /* The text name assigned to the task, for
                                                           debug only; not used by the kernel. */
                       fast_pair_task,                  /* The function that implements the task. */
                       NULL,                            /* The parameter passed to the task. */
                       2560,                            /* The number of bytes to allocate to the
                                                           stack of the task. */
