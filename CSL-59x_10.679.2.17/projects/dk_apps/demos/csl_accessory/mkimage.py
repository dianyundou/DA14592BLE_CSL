...
if __name__ == '__main__':
    ...
    if args.prod_id == ProductId.DA1459x_00.value:
        mkimage('{}/csl_accessory.raw.bin'.format(args.build_configuration), prod_id=ProductId(args.prod_id), secure_cfg_file=args.security_config_file, keys_file=args.keys_file)
    else:
        mkimage('{}/csl_accessory.bin'.format(args.build_configuration), prod_id=ProductId(args.prod_id))
