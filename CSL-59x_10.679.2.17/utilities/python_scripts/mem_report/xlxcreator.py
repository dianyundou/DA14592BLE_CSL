...
class AbsExcelWriter:
    ...
    @abstractmethod
    def set_column(self, sheet_name, col, width, cell_format=None, options=None):
        """
        ...
        :param cell_format: Optional Format object (Format)
        :param options: Optional parameters: hidden, level, collapsed (dict)
        """
        pass
...
class XLwithXlswriter(AbsExcelWriter):
    ...
    def set_column(self, sheet_name, col, width, cell_format=None, options=None):
        self._ws[sheet_name].set_column(col, col, width, cell_format, options)
