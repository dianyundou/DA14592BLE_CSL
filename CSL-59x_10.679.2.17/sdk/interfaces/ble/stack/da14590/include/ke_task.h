 ...
 *
 * Copyright (c) 2017-2023 Modified by Renesas Electronics Corporation and/or its affiliates.
 *
 *
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Reschedule the saved messages of a specific task
 *
 * @param[in]  ke_task_id  Identifier of the task instance whose state is going to be modified
 *
 ****************************************************************************************
 */
void ke_saved_msg_reschedule(ke_task_id_t const ke_task_id);
